    ...
    def evaluate(self) -> dict:
        ...
        for deployment_name in deployment_names:
            for _ in range(self.RETRIES):
                ...
                # print("[DEBUG] CPU usage: ", usage_dict)
                ...
                if max_usage > average_others * 3:
                    print(f"❌ Deployment {deployment_name} still not balanced (max usage: {max_usage}, average others: {average_others})")
