...
When using kind, each node pulls images from docker hub independently, which can easily hit the rate limitation. You can set up your private registry by following [PRIVATE_REGISTRY](kind/PRIVATE_REGSITRY.md) to circumvent this issue.
